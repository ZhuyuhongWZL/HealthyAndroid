...
//    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        String url =  "http://"+ Content.IP +":8080/" +  iData.get(groupPosition).get(childPosition).getiName();
        Glide.with(mContext).load(url).error(R.drawable.profile).into(itemHolder.img_icon);
       // Toast.makeText(mContext, "-->"+iData.get(groupPosition).get(childPosition).getiName(), Toast.LENGTH_SHORT).show();
